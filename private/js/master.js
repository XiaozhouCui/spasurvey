...
var toolTips = {
	...
	'exec': 'The <strong>Senior Leadership Team</strong> is defined as:<ul><li>Chief Executive Officer – <em>Carol Jeffs</em></li><li>General Manager Infrastructure and Environment – <em>Peter Benazic</em></li><li>General Manager Customer, People and Performance – <em>Jenny Scicluna</em></li><li>General Manager Liveable Communities – <em>Tracey Parker</em></li><li>Executive Manager Office of the CEO – <em>Tom McQualter</em></li></ul>',
	'seni': '<strong>Senior Management</strong> is defined as: <ul><li></li></ul>',
	'midd': '<strong>Management</strong> includes:<ul><li>Chief Finance Officer</li><li>Manager, Information Services</li><li>Manager, Governance</li><li>Manager, Customer & Service Improvement</li><li>Manager, Community & Family Services</li><li>Manager, Active Communities</li><li>Manager, Community Strengthening</li><li>Manager, Buildings & Facilities</li><li>Manager, Operations</li><li>Manager, Infrastructure Services</li><li>Manager, Development & Compliance Services</li><li>Manager, Policy Design Growth Area Planning</li><li>Manager, Economic Development</li><li>Manager, People & Culture</li><li>Manager, Environment & Heritage</li><li>Team Leader, Communications</li></ul>',
